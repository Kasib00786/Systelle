...
const [open,setOpen]=useState(false);
  return (
    <div className='bg-gradient-to-r from-pink-100 to-indigo-200 min-h-screen'>
        ...
        <div className='mt-16 max-w-[85%]  p-2 rounded-2xl mx-auto shadow-lg z-10 flex gap 2'>
            <div className='bg-white/80 flex pl-2 max-w-[85%]'>
                <h2 className='font-semibold text-lg'>1.How was your flowing?</h2>
